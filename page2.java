...
public class page2 extends JFrame implements ActionListener,WindowListener {
	...
	public void loadData(){
		...
		try{
			...
			while(rs.next()){
				...
				data=data+rs.getString("Department")+"-";
				data=data+rs.getString("Sex")+"-";
				data=data+rs.getString("pass")+"-";
				data=data+rs.getString("p_number")+"\n";
			}
			ta.setText(data);
		}
		catch(Exception ex){
